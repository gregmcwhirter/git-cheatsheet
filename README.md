...
Go back to commit:
`git revert 073791e7dd71b90daa853b2c5acc2c925f02edc6`

Soft reset (move HEAD only; neither staging nor working dir is changed):
`git reset --soft 073791e7dd71b90daa853b2c5acc2c925f02edc6`
...
Compare commits:
`git diff 6db72b2d`
`git diff 6db72b2d..HEAD`
`git diff 6db72b2d..538a08e`

Compare commits of file:
`git diff 6db72b2d index.html`
`git diff 6db72b2d..538a08e index.html`

Compare without caring about spaces:
`git diff -b 6db72b2d..HEAD` or:
`git diff --ignore-space-change 6db72b2d..HEAD`

Compare without caring about all spaces:
`git diff -w 6db72b2d..HEAD` or:
`git diff --ignore-all-space 6db72b2d..HEAD`

Useful comparings:
`git diff --stat --summary 6db72b2d..HEAD`
...
`git tag -a v1.4.1 -m 'the message'`
...
`git remote add origin ssh://root@122.128.148.88/path/to/repository/file.git`
